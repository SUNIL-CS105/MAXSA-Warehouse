...
window.locations = {
  ...
  dropZones: [
    { id: "SHIPPED", name: "SHIPPED", left: 1355, top: 1100, width: 255, height: 82, color: '#e74c3c' },
    { id: "TO-8412-OFFICE", name: "TO-8412-OFFICE", left: 1355, top: 950, width: 255, height: 82, color: '#2980b9' }
  ]
};
